...
#define IPB           (BSIZE / sizeof(struct dinode))
  ...
  #define STAT_PERCENTAGE_ABS(stat, totalBlocks, sb) ( stat->usedBlocks = totalBlocks; ((totalBlocks * 100) / sb.ipbg) )
...
#define diNode_info(d) do{                                                                                                                                \
                          ...
                          int i;                                                                                                                          \
                          for(i=0; i < NDIRECT; i++){                                                                                                     \
                               if(d->addrs[i]) cprintf("%d,",d->addrs[i]);                                                                                \
                          }                                                                                                                               \
                          if(d->addrs[NDIRECT]) cprintf("Indirect => %d", d->addrs[NDIRECT]);                                                     \
                          cprintf("] }\n");                                                                                                               \
                          }while(0)                                                                                                       
